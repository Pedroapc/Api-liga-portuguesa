...
exports.registar = async (req, res) => {
  ...
  try {
    ...
    const URLconfirm = `http://localhost:8080/api/auth/confirm/${confirmationToken}`
...
exports.benfica = (req, res) => {
  ...
  model_articles.benfica(req, res)
}
exports.sporting = (req, res) => {
  authenticateToken(req, res)
  model_articles.sporting(req, res)
}
exports.porto = (req, res) => {
  authenticateToken(req, res)
  model_articles.porto(req, res)
}
exports.classificacao = (req, res) => {
  authenticateToken(req, res)
  model_articles.classificacao(req, res)
}